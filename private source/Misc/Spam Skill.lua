...
M_T: mouse.taget,
Charge,
CM: ChargeMode = {"Left", "Right"},
M_H_P: mouse.hit.p,
ARM_P: game.Players.LocalPlayer.Character["Right Arm"].Position,
HRP_P: game.Players.LocalPlayer.Character.HumanoidRootPart.Position,
DS_SL: Data.SniperLevel.Value,
DS_DL: Data.DefenseLevel.Value,
GT: All Near Players,
GetDotPoint: form 00.lua,
C_GDP: CFrame.new(GetDotPoint)
]]
...
MyClass:Set("Light2", "Power2", {"VTC", "FN", "SC", "M_H", "M_T", "C"});
MyClass:Set("Light2", "Power3", {"VTC", "FN", "SC", "HRP_P", "M_H_P", "C"});
