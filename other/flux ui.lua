...
tab:Line()
tab:Toggle("Auto-Farm Coins", "Automatically collects coins for you!", false, function(Boolean)
    print(t)
end)
tab:Slider("Walkspeed", "Makes your faster.", 0, 100,16,function(Value)
    print(t)
end)
tab:Dropdown("Part to aim at", {"Torso","Head","Penis"}, function(Value)
    print(t)
end)
tab:Colorpicker("ESP Color", Color3.fromRGB(255,1,1), function(Value)
    print(t)
end)
tab:Textbox("Gun Power", "This textbox changes your gun power, so you can kill everyone faster and easier.", false, function(Value)
    print(t)
end)
